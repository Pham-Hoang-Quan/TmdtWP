...
<p class="has-text-align-left has-primary-color has-text-color has-medium-font-size" style="font-style:normal;font-weight:500"><?php esc_html_e('Display all Products from Store','blackcart');?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"left","style":{"typography":{"lineHeight":"1.5"}},"textColor":"foreground"} -->
<h2 class="wp-block-heading has-text-align-left has-foreground-color has-text-color" style="line-height:1.5"><?php esc_html_e('All Products !!!','blackcart');?></h2>
<!-- /wp:heading --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:woocommerce/product-button {"className":"is-style-outline","textColor":"primary","style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}}} -->
<div class="wp-block-woocommerce-product-button is-loading is-style-outline has-primary-color has-text-color has-link-color"></div>
