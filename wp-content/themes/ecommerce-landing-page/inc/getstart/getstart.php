				...
				<div class="table-image">
					<table class="tablebox">
						...
						<tbody>
							...
							<tr>
								<td><?php esc_html_e('Slider Settings', 'ecommerce-landing-page'); ?></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
							</tr>
							<tr class="odd">
								<td><?php esc_html_e('Number of Slides', 'ecommerce-landing-page'); ?></td>
								<td class="table-img"><?php esc_html_e('4', 'ecommerce-landing-page'); ?></td>
							...
							<tr class="odd">
								<td><?php esc_html_e('Contact us Page Template', 'ecommerce-landing-page'); ?></td>
							...
							<tr class="odd">
								...
								<td class="table-img">0</td>
								<td class="table-img"><?php esc_html_e('2(Left/Right Sidebar)', 'ecommerce-landing-page'); ?></td>
							</tr>
							<tr>
